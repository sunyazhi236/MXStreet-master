...
@interface StreetPhotoDetailViewController () <UITextFieldDelegate,TencentSessionDelegate, WXApiDelegate>
{
...
//                            [labelButton setImageEdgeInsets:UIEdgeInsetsMake(0, -10, 0, 0)];
                ...
                if ([CustomUtil CheckParam:publishInfo.streetsnapContent]) {
                    ...
                    publishContextRect.origin.y = _locationImageView.frame.origin.y + _locationImageView.frame.size.height + Y_OFFSET;
