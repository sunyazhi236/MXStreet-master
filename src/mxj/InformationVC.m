...
-(void)initView{
    ...
    UILabel *nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(55, 185, 40, 30)];
    nameLabel.text = @"昵称";
    nameLabel.font = [UIFont systemFontOfSize:13.0f];
    nameLabel.textColor = [UIColor colorWithHexString:@"a3a3a3"];
    [self.view addSubview:nameLabel];
    _nameTextField = [[LineTextField alloc] initWithFrame:CGRectMake(55, 185, SCREENWIDTH - 110, 30)];
    ...
    UILabel *addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(55, 255, 40, 30)];
    ...
    _addressTextField = [[LineTextField alloc] initWithFrame:CGRectMake(55, 255, SCREENWIDTH - 110, 30)];
